  ...
  return (
    <section className="max-w-7xl mx-auto px-4 mt-12">
      <div className="flex items-end justify-between mb-6">
        ...
        <Link
          to="/products"
          className="hidden md:inline-block text-sm font-semibold text-brand-pink hover:underline"
        >
          View All →
        </Link>
      </div>
      ...
      <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-3 md:gap-4">
        {categories.map((cat) => (
          ...
          >
            ...
            <h3 className="text-xs md:text-sm font-semibold text-brand-dark leading-tight line-clamp-2">
              {cat.name}
            </h3>
